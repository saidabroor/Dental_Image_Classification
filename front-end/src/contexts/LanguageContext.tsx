...
const translations = {
  en: {
    ...
    'hero.description': 'Your AI-powered dental health assistant. Upload a photo of your tooth and get instant analysis to check for signs of decay or health issues.',
    'hero.disclaimer': 'Please note: This is an AI screening tool for educational purposes. Always consult with a qualified dentist for professional diagnosis and treatment.',
    ...
    'result.recommendation': 'Recommendation: Please consult with a dental professional for proper diagnosis and treatment.',
    'result.disclaimer.title': 'Important Disclaimer',
    'result.disclaimer.text': 'This is an AI analysis for informational purposes only and should not replace professional dental examination. Always consult with a qualified dentist for accurate diagnosis and treatment.',
    'result.analyze.again': 'Analyze Another Photo',
    
    // How It Works
    'how.title': 'How It Works',
    'how.description': 'Our AI-powered system uses advanced deep learning technology trained on thousands of dental images to help identify potential tooth decay and health issues.',
    ...
    'how.step2.desc': 'Our deep learning model analyzes the image for signs of decay',
  ...
  ko: {
    ...
    'hero.description': 'AI 기반 치아 건강 도우미입니다. 치아 사진을 업로드하여 충치나 건강 문제의 징후를 즉시 분석받으세요.',
    'hero.disclaimer': '참고사항: 이것은 교육 목적의 AI 스크리닝 도구입니다. 전문적인 진단과 치료를 위해서는 항상 자격을 갖춘 치과의사와 상담하세요.',
    ...
    'result.recommendation': '권장사항: 정확한 진단과 치료를 위해 치과 전문의와 상담하시기 바랍니다.',
    'result.disclaimer.title': '중요한 면책조항',
    'result.disclaimer.text': '이것은 정보 제공 목적의 AI 분석이며 전문적인 치과 검진을 대체할 수 없습니다. 정확한 진단과 치료를 위해서는 항상 자격을 갖춘 치과의사와 상담하세요.',
    'result.analyze.again': '다른 사진 분석하기',
    
    // How It Works
    'how.title': '작동 원리',
    'how.description': '저희 AI 기반 시스템은 수천 장의 치과 이미지로 훈련된 고급 딥러닝 기술을 사용하여 잠재적인 치아 충치와 건강 문제를 식별하는 데 도움을 줍니다.',
    ...
    'how.tech.desc': 'ToothHealth.AI는 포괄적인 치과 이미지 데이터셋으로 훈련된 최첨단 합성곱 신경망으로 구동됩니다. 저희 모델은 건강한 치아와 충치(치아 충치) 징후를 보이는 치아를 높은 정확도로 구별할 수 있습니다. 시스템은 치아 건강 문제를 나타낼 수 있는 변색, 표면 질감, 구조적 변화를 포함한 다양한 시각적 지표를 분석합니다.',
    
    // Footer
    'footer.description': '치아 건강 스크리닝을 위한 고급 AI 기술. 즉각적이고 지능적인 분석으로 사람들이 구강 건강을 더 잘 관리할 수 있도록 돕습니다.',
    'footer.contact': '연락처',
    'footer.notice.title': '중요 공지',
    'footer.notice.text': '이 도구는 교육 및 스크리닝 목적으로만 사용됩니다. 정확한 진단과 치료를 위해서는 항상 자격을 갖춘 치과 전문의와 상담하세요.',
    'footer.made': '더 나은 치아 건강을 위해',
    'footer.for': '사랑으로 제작',
    'footer.rights': '© 2024 ToothHealth.AI. 모든 권리 보유.'
  }
};
